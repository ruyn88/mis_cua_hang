...
$sql = "SELECT mh.id_mat_hang, mh.ten_mat_hang, lh.ten_loai_hang
...
?>
    ...
    ?>
            <tr>
                    <td><?php echo $matHang['id_mat_hang']; ?></td>
                    <td><?php echo $matHang['ten_mat_hang']; ?></td>
                    <td><?php echo $matHang['ten_loai_hang']; ?></td>
                    <td>
                        <a class="btn btn-info" href="sua_mat_hang.php?id=<?php echo $matHang['id_mat_hang'];?>">Sửa</a>  
                        <a class="btn btn-danger" href="xoa_mat_hang.php?id=<?php echo $matHang['id_mat_hang'];?>">Xóa</a>
