...
$sql = "SELECT mh.id_mat_hang, mh.ten_mat_hang, lh.ten_loai_hang, mh.hinh_anh, mh.gia_ban
        ...
        <div class="col-sm-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <img src="assets/images/n5620.jpg"<?php echo $matHang['hinh_anh']; ?> class="img-responsive" style="width:100%" alt="Image">
                </div>
